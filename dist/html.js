...
function html(content, opt) {
    opt.content = content;
    return '<!DOCTYPE html>\n    <html>\n    <head>\n        <meta charset="utf-8">\n        <meta name="viewport" content="width=device-width, initial-scale=1, user-scalable=0"/>\n        <meta http-equiv="X-UA-Compatible" content="IE=edge"/>\n        <title>' + (opt.title || 'component demo') + '</title>\n    </head>\n    <body>\n    ' + React.renderToStaticMarkup(React.createElement(Wrapper, opt)) + '\n    </body>\n    </html>';
}

module.exports = {
    example: function example(opt) {
        var opt = opt || {};
        var content = React.renderToStaticMarkup(React.createElement(DemoPage, opt));
        return html(content, opt);
    },
    list: function list(opt) {
        var opt = opt || {};
        var content = React.renderToStaticMarkup(React.createElement(List, opt));
        return html(content, opt);
    }
};